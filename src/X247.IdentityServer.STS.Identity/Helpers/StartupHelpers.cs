...
using SendGrid;
using X247.IdentityServer.STS.Identity.Configuration;
using X247.IdentityServer.STS.Identity.Configuration.ApplicationParts;
using X247.IdentityServer.STS.Identity.Configuration.Constants;
using X247.IdentityServer.STS.Identity.Configuration.Interfaces;
using X247.IdentityServer.STS.Identity.Helpers.Localization;
using X247.IdentityServer.STS.Identity.Services;
using System.Linq;
using Skoruba.IdentityServer4.Admin.EntityFramework.Interfaces;
using X247.IdentityServer.Admin.EntityFramework.MySql.Extensions;
using X247.IdentityServer.Admin.EntityFramework.PostgreSQL.Extensions;
using X247.IdentityServer.Admin.EntityFramework.Shared.Configuration;
using X247.IdentityServer.Admin.EntityFramework.SqlServer.Extensions;
using Skoruba.IdentityServer4.Admin.EntityFramework.Helpers;

namespace X247.IdentityServer.STS.Identity.Helpers
{
            ...
            var builder = services.AddIdentityServer(options =>
                {
                    ...
                    options.PublicOrigin = configuration.GetSection("Host").Value;
                })

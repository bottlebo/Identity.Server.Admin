...
using X247.IdentityServer.Admin.ExceptionHandling;
using X247.IdentityServer.Admin.Configuration;
using X247.IdentityServer.Admin.Configuration.ApplicationParts;
using X247.IdentityServer.Admin.Configuration.Constants;
using X247.IdentityServer.Admin.Configuration.Interfaces;
using Skoruba.IdentityServer4.Admin.EntityFramework.Interfaces;
using Skoruba.IdentityServer4.Admin.EntityFramework.Repositories;
using Skoruba.IdentityServer4.Admin.EntityFramework.Repositories.Interfaces;
using X247.IdentityServer.Admin.Helpers.Localization;
using System.Linq;
...
namespace X247.IdentityServer.Admin.Helpers
{

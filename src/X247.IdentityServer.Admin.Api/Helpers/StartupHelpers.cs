...
using X247.IdentityServer.Admin.Api.AuditLogging;
using X247.IdentityServer.Admin.Api.Configuration;
using X247.IdentityServer.Admin.Api.Configuration.ApplicationParts;
using X247.IdentityServer.Admin.Api.Configuration.Constants;
using X247.IdentityServer.Admin.Api.Helpers.Localization;
...
namespace X247.IdentityServer.Admin.Api.Helpers
{

...
using X247.IdentityServer.Admin.Api.Configuration.Authorization;
using X247.IdentityServer.Admin.Api.ExceptionHandling;
using X247.IdentityServer.Admin.Api.Helpers;
using X247.IdentityServer.Admin.Api.Mappers;
using X247.IdentityServer.Admin.Api.Resources;
using Skoruba.IdentityServer4.Admin.BusinessLogic.Identity.Dtos.Identity;
using X247.IdentityServer.Admin.EntityFramework.Shared.DbContexts;
using X247.IdentityServer.Admin.EntityFramework.Shared.Entities.Identity;

namespace X247.IdentityServer.Admin.Api
{
